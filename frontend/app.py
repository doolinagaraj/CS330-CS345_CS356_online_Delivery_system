...
def customer_action():
    ...
    if action == 'view':
        result = run_cpp('customer_portal')
    else:
        result = {"status": "error", "message": "Invalid customer action"}
...
def shopkeeper_action():
    ...
    if action == 'add_item':
        ...
        result = {"status": "error", "message": "Invalid shopkeeper action"}
    return jsonify(result)
...
def moderator_action():
    ...
    if action == 'list_users':
        ...
        result = {"status": "error", "message": "Invalid moderator action"}
    return jsonify(result)
